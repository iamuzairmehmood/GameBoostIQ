...
import com.iamuzairmehmood.GameStats.model.CapabilityCategory
import com.iamuzairmehmood.GameStats.model.CapabilityItem
import com.iamuzairmehmood.GameStats.model.DeviceCapabilitiesReport
import com.iamuzairmehmood.GameStats.model.SupportStatus
import com.iamuzairmehmood.GameStats.monitor.DisplayMonitor
import java.io.File
        ...
        val networkCategory = CapabilityCategory(
            ...
            items = listOf(
                ...
                CapabilityItem(
                    ...
                    technicalDetails = "GameStats provides honest network diagnostics rather than false network acceleration promises."
                )
            )
        )
        ...
        val gamingCategory = CapabilityCategory(
            ...
            items = listOf(
                ...
                CapabilityItem(
                    ...
                    technicalDetails = "Reverts only settings GameStats modified; reports manual items honestly"
                )
            )
        )

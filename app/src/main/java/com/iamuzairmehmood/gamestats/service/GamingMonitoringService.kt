...
class GamingMonitoringService : Service() {
    ...
    companion object {
        const val CHANNEL_ID = "gamestats_gaming_mode_channel"
        const val NOTIFICATION_ID = 1001

        const val ACTION_START = "com.example.gamestats.ACTION_START"
        const val ACTION_STOP = "com.example.gamestats.ACTION_STOP"
    ...
    private fun buildNotification(gameName: String, modeName: String, statsText: String): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("GameStats: $gameName ($modeName)")

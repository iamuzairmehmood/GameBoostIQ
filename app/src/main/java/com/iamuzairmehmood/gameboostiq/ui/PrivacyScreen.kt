...
fun PrivacyScreen(onBack: () -> Unit) {
    Scaffold(
        ...
        Column(
            ...
            Text(
                "Game BoostIQ is designed to operate using standard Android APIs without modifying game software. No third-party application can guarantee compatibility with every game, Android version, OEM implementation, or anti-cheat system.",
                fontSize = 13.sp,
            ...
            Text(
                "Game BoostIQ utilizes local-first processing. Session data is stored locally on your device. We do not collect unnecessary personal data. The app does not read or store game credentials, passwords, or game-account information.",
                fontSize = 13.sp,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
            ...
            Text(
                "Game BoostIQ does not inject code into games, modify game memory or files, manipulate gameplay, bypass anti-cheat systems, or modify game network packets.",
                fontSize = 13.sp,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
            ...
            Text(
                "Game BoostIQ is open source and its source code is available under the applicable project license.",
                fontSize = 13.sp,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
        }

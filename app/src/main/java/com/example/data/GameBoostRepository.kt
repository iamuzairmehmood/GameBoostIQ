...
class GameBoostRepository(
    ...
    suspend fun scanAndSeedInstalledGames() {
        withContext(Dispatchers.IO) {
            ...
            // Known popular gaming package signatures with Free Fire & Free Fire MAX priority
            ...
            // Always provide high-profile game presets prioritizing Free Fire & Free Fire MAX
